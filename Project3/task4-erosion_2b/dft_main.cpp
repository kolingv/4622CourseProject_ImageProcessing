...
using namespace std;
/*****************************************************************************/
/*                  my_image_comp::perform_boundary_extension(odd symetric)                */
/*****************************************************************************/

void my_image_comp::perform_boundary_extension_sym()
{
  int r, c;
...
/*****************************************************************************/
/*                  my_image_comp::perform_boundary_extension(zero-oder hold)               */
/*****************************************************************************/
void my_image_comp::perform_boundary_extension_0order()
{
  int r, c;
  ...
  main(int argc, char *argv[])
{
	 ...
	 if (argc != 5) // pairs of elements(vectors) 
    {
      fprintf(stderr,"Usage: %s <in bmp file> <out bmp file> radius extension_method(0 or 1)\t 0 represents symetric; 1 means 0-order hold\n",argv[0]);
	  //fprintf("0 represents symetric; 1 means 0-order hold\n");
      return -1;
    }
  ...
  try {
	  ...
	  */
	  ...
	  // extension, 0 represents symetric; 1 means 0-order hold
		if(extd_metd)
		{
			for (n=0; n < num_comps; n++)
			 input_comps[n].perform_boundary_extension_0order();
		}
		else 
		{
			for (n=0; n < num_comps; n++)
			 input_comps[n].perform_boundary_extension_sym();
		}
